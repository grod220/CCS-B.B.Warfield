  ...
  <OuterContainer>
    <InnerContainer>
      ...
      <RightSide>
        ...
        <p>
          It's only 5 min walk away from Rådmansgatan subway station (green
          line). Above is a picture of the outside. It’s not the main entrance,
          but the door to its left (look for 66B).
        </p>
      </RightSide>
    </InnerContainer>
  </OuterContainer>
